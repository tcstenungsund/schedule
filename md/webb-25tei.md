...
[Uppgift: HTML & CSS Basics](https://tcstenungsund.github.io/schedule/assignment.html?link=assignments/webb1-html_css_basics)  
...
Först går vi igenom hur en HTML-tagg är uppbyggd, sedan djupdyker vi i hur man märker upp text på alla möjliga sätt och vis.  
...
Läs på om [The anchor element](https://heydonworks.com/article/the-anchor-element/),
det är viktigt. Det går också att djupdyka i taggen [HEAD](https://htmlhead.dev/) och
allt den kan innehålla. Om det är svårt att hålla ordning på den semantiska
betydelsen hos taggar är [HTML5 Doctor's flowchart](https://html5doctor.com/downloads/h5d-sectioning-flowchart.pdf)
en bra resurs.

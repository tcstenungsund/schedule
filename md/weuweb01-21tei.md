...
En webbsida bör byggas och utveckla med fakta som bas. För att få fakta om just din webbplats används olika sorters tester. Att testa innebär ALDRIG att fråga någon vad de tycker. Istället har vi användbarhetstestning (usability testing), hastighetstestning (speed testing), tillgänglighetstestning (a11y testing) och många fler.   

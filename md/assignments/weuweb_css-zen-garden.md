...
4) Skriv en kommentar högst upp i CSS-dokumentet där du anger vilka resurser du nyttjat (t.ex: färdiga CSS-komponenter, LLM eller liknande)  
5) När lektionstiden är slut [tar du ett screenshot](https://support.mozilla.org/en-US/kb/take-screenshots-firefox) av hela sidan  

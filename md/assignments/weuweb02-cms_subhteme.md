...
Börja med att ladda ned Barrio och packa upp filen. Kopiera alla filer i katalogen bootstrap_barrio/subtheme och lägg dem i din subhteme-katalog. Fortsätt nu att följa guiden som är länkad under resurser ovan och byt namn på 5 filer samt gör de justeringar i filerna som behövs.  

Nu borde dina filer se ut ungefär som i bilden nedan (eventuellt finns inte katalogen common, den spelar ingen roll).  

![Projektfilstruktur](https://i.imgur.com/9Ullbgu.png) 

Logga nu in på din Drupal-installation och sätt ditt subtheme som standardtheme.  
...
Bygg nu upp en enkel liten sida med block, pages och menyalternativ.  

...
## Uppgiftsbeskrivning  
1) När Docker är installerat så kör du följande kommando, öppnar localhost i din webbläsare och läser igenom getting-started-tutorialen.  

    docker run -d -p 80:80 docker/getting-started

2) Ta reda på vad följande kommandon gör, lär dig dem och testa dem i din miljö ("[8 Basic Docker Commands](https://youtu.be/xGn7cFR3ARU)").  
...
3) Sök på nätet och leta fram tre Operativ System som inte är Windows eller Linux och som intresserar dig! Undersök om någon av dem går att köra i Docker och testkör ditt utvalda projekt!  
